...
int main(int argc, char **argv)
{
    ...
    // examples
    ShuildExample("1_boolean");
    ShuildExample("2_numbers");
    ShuildExample("3_string");
    ShuildExample("4_list");

#ifdef _WIN32
    SHU_UtilRun("1_boolean.exe");

    SHU_UtilRun("2_numbers.exe");
    SHU_UtilRun("3_string.exe");
    SHU_UtilRun("4_list.exe");

#else
    SHU_UtilRun("./1_boolean.ignore");
    SHU_UtilRun("./1_boolean.ignore");

    SHU_UtilRun("./2_numbers.ignore");
    SHU_UtilRun("./3_string.ignore");
    SHU_UtilRun("./4_list.ignore");
